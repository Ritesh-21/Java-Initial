...
class Calc1 extends demo implements Runnable // "EXTENDS " & " IMPLEMENTS " Both can be use at a time 
 {
...
public class Tut6 {  
    public static void main(String[] args) {
        ...
        t1.start();
        t2.start(); // ia se MULTI THREADING HOGI 

        // t1.run();
        // t2.run(); iss se SINGLE THREADING hogi 
